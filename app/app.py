...
user = 'user'           # username as set for the mongodb admin server (the username used in secret.yaml - before base64 conversion)
...
db = MongoClient(conn_string,connect=False).blog
