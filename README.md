...
`commands.txt` files have all the execution commands which should be rum cmd prompt.

# Additional Information
   We were asked to change the port of the blog app from 5001 to some other port. We changed it from port `5001` to `5000` port number and also create the database using mongoexpress front end which is accessed through `localhost:8081`.

# Team Number 10 

# Team Members:
1. Pawan Prasad P - PES2UG19CS280
2. Rahul S Bhat - PES2UG19CS315
3. Phani Kumar Vedurumudi - PES2UG19CS281
4. Pavan B K - PES2UG19CS276

All Team members are from section-**E** EC CAMPUS
